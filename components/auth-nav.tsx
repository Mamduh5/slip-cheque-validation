...
export function AuthNav({
  ...
  if (!isSignedIn) {
    return (
      <nav className="flex items-center gap-2 text-sm" aria-label={t("navigation.public")}>
  ...
  return (
    <nav className="flex flex-wrap items-center justify-end gap-2 text-sm" aria-label={t("navigation.main")}>
